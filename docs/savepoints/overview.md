...
| [aov_debug_status.md](aov_debug_status.md) | `trace` | ViewState-driven debug AOVs: geometry wireframe/normals/depth/backface, point/beam coloring modes, per-instance and per-medium filters. 3/5 tasks done. |
